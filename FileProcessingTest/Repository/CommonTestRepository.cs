...
namespace FileProcessingTest.Repository
{
    public class CommonTestRepository
    {
        ...
        public List<FileReceivedEntry> GetFileReceivedEntry(string fileName)
        {
            ...
            return DataUtilities.SqlExecuteReader<FileReceivedEntry>(_connection, DataUtilities.CommandTimeout, sql, parameters);
        }
        ...
        public List<JobQueueEntry> GetJobQueueEntry(int clientFileTypeID, long fileReceivedId, int jobType)
        {
            ...
            return DataUtilities.SqlExecuteReader<JobQueueEntry>(_connection, DataUtilities.CommandTimeout, sql, parameters);
        }
        ...
        public JobQueueEntry GetJobQueueEntry(long jobQueueId)
        {
            ...
            return DataUtilities.SqlExecuteReader<JobQueueEntry>(_connection, DataUtilities.CommandTimeout, sql, parameters).Single();
        }
        ...
        public List<int> GetNewAccountId(string clientAccountNumber)
        {
            ...
            return DataUtilities.SqlExecuteReader<int>(_connection, DataUtilities.CommandTimeout, sql, parameters);
        }
        ...
        public List<string> GetListOfClientAccountsFromView(string tableView, string fieldName, long fileReceivedId)
        {
            ...
            return DataUtilities.SqlExecuteReader<string>(_connection, DataUtilities.CommandTimeout, sql, parameters);
        }
        ...
        public List<AccountPhonesRecords> GetAccountPhonesRecords(int accountId)
        {
            using (var conn = new SqlConnection())
            {
                ...
                return DataUtilities.SqlExecuteReader<AccountPhonesRecords>(_connection, DataUtilities.CommandTimeout, sql, parameters);
            }
        }
