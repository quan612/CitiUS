...
namespace CitiUSTest.FeatureFiles.CitiNBSFeatures
{
    ...
    [NUnit.Framework.DescriptionAttribute("CitiNBSTestXRecord")]
    public partial class CitiNBSTestXRecordFeature
    {
...
#line 1 "CitiNBSTestXRecord.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "CitiNBSTestXRecord", "\tEverything related to \"X\" record\r\n\t\t\r\nIBM Signed Numeric Table\r\n{ = 0     } = -0" +
                    "\r\nA = 1     J = -1\r\nB = 2     K = -2\r\nC = 3     L = -3\r\nD = 4     M = -4\r\nE = 5 " +
                    "    N = -5\r\nF = 6     O = -6\r\nG = 7     P = -7\r\nH = 8     Q = -8\r\nI = 9     R = " +
...
#line hidden
                ...
                table302.AddRow(new string[] {
                            "12345A"});
#line 28
 testRunner.Given("The user modifies the X record in DL file with credentials:", ((string)(null)), table302, "Given ");
#line hidden
#line 31
...
#line hidden
                ...
                table303.AddRow(new string[] {
                            "99999H"});
#line 38
 testRunner.Given("The user modifies the X record in DL file with credentials:", ((string)(null)), table303, "Given ");
#line hidden
#line 41
 testRunner.When("The user drops the file to the client UNC path", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table304.AddRow(new string[] {
                            "123456G"});
#line 48
 testRunner.Given("The user modifies the X record in DL file with credentials:", ((string)(null)), table304, "Given ");
#line hidden
#line 51
 testRunner.When("The user drops the file to the client UNC path", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table305.AddRow(new string[] {
                            "123456{"});
#line 58
 testRunner.Given("The user modifies the X record in DL file with credentials:", ((string)(null)), table305, "Given ");
#line hidden
#line 61
 testRunner.When("The user drops the file to the client UNC path", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table306.AddRow(new string[] {
                            "012342B"});
#line 68
 testRunner.Given("The user modifies the X record in DL file with credentials:", ((string)(null)), table306, "Given ");
#line hidden
#line 71
 testRunner.When("The user drops the file to the client UNC path", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table307.AddRow(new string[] {
                            "5466C"});
#line 78
 testRunner.Given("The user modifies the X record in DL file with credentials:", ((string)(null)), table307, "Given ");
#line hidden
#line 81
 testRunner.When("The user drops the file to the client UNC path", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table308.AddRow(new string[] {
                            ...
                            "91222212345A"});
#line 88
 testRunner.Given("The user modifies the X record in DL file with credentials:", ((string)(null)), table308, "Given ");
#line hidden
#line 91
 testRunner.When("The user drops the file to the client UNC path", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
