...
namespace CitiUSTest.FeatureFiles.CitiOutgoingMaintenanceFeatures
{
    ...
    [NUnit.Framework.DescriptionAttribute("Phone Update To Home for OILS")]
    ...
    public partial class PhoneUpdateToHomeForOILSFeature
    {
...
#line 1 "PhoneUpdateToHomeForOILS.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Phone Update To Home for OILS", "\tTo test sending of phone to Citi related to Home\t", ProgrammingLanguage.CSharp, new string[] {
                        "OutboundMaintenance",
                        "Home",
                        "OILS"});
...
#line hidden
            ...
            table769.AddRow(new string[] {
                        ...
                        "2019/08/15"});
#line 7
 testRunner.And("The user modifies the header record with credentials:", ((string)(null)), table769, "And ");
#line hidden
            ...
            table770.AddRow(new string[] {
                        ...
                        "GIC5"});
#line 10
 testRunner.And("The user modifies the recoverer in DL file with credentials:", ((string)(null)), table770, "And ");
#line hidden
        }
        
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("CITI_4347")]
        public virtual void CITI_4347()
        {
            string[] tagsOfScenario = ((string[])(null));
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("CITI_4347", "Citi Home Work are different and good, there is no other phone in ARx, receive Ce" +
                    "ll that matches Citi Home in MT file, add a new Home in ARx (OILS)", ((string[])(null)));
#line 14
...
#line hidden
                ...
                table771.AddRow(new string[] {
                            ...
                            "E"});
#line 16
 testRunner.Given("The user modifies the account record in DL file with credentials:", ((string)(null)), table771, "Given ");
#line hidden
#line 19
...
#line hidden
                ...
                table773.AddRow(new string[] {
                            ...
                            "Y"});
#line 33
 testRunner.Then("The records are sent in the outbound maintenance file as below:", ((string)(null)), table773, "Then ");
#line hidden
            }
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("CITI_4119")]
        public virtual void CITI_4119()
        {
            string[] tagsOfScenario = ((string[])(null));
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("CITI_4119", "Citi Home is good and then user changes the Home to Wrong Number (OILS)", ((string[])(null)));
#line 40
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
...
#line hidden
                ...
                table774.AddRow(new string[] {
                            ...
                            "E"});
#line 42
 testRunner.Given("The user modifies the account record in DL file with credentials:", ((string)(null)), table774, "Given ");
#line hidden
#line 45
...
#line hidden
#line 48
 testRunner.And("the user adds a new number 6479993333 with status Active location Home service La" +
...
#line hidden
                ...
                table775.AddRow(new string[] {
                            ...
                            "Y"});
#line 53
 testRunner.Then("The records are sent in the outbound maintenance file as below:", ((string)(null)), table775, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
